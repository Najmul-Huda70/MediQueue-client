...
export default function Hero() {
  return (
    <section className="relative w-full bg-linear-to-b from-blue-50/50 via-white to-white overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
                ...
                <p className="text-lg text-gray-600 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                  Find and book real-time online learning sessions based on
                  subject and time availability. Eliminate conflicts, manage
                  digital tokens, and track your schedules seamlessly.
                </p>
              ...
              <div className="lg:col-span-5 relative w-full flex justify-center items-center">
                ...
                <div className="relative w-full max-w-110 aspect-square rounded-3xl overflow-hidden border-[6px] border-white shadow-2xl bg-gray-100">
                  <Image
